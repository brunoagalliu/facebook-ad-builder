/** Ports backend/app/prompts/ad_remix_prompts.py verbatim. */

export const DECONSTRUCTION_PROMPT = `You are a master creative strategist analyzing advertising templates.
...
export const RECONSTRUCTION_PROMPT_TEMPLATE = (params: {
  ...
  campaignUrgency: string;
  campaignMessaging: string;
}): string => `You are a Senior Creative Director creating a new ad concept.
...
- Target Audience: ${params.audienceDemographics}
- Audience Pain Points: ${params.audiencePainPoints}
- Audience Goals: ${params.audienceGoals}
- Campaign Offer: ${params.campaignOffer}
- Campaign Urgency: ${params.campaignUrgency}
- Key Messaging: ${params.campaignMessaging}
