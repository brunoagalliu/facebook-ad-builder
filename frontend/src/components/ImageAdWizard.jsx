        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-surface rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="px-8 py-6 border-b border-border">
                    ...
                    <p className="text-ink-tertiary mt-1">Generate AI-powered ads using winning templates</p>
                </div>

                {/* Progress Steps */}
                <div className="px-8 py-6 border-b border-border bg-surface-hover">
                    <div className="flex items-center justify-between relative">
                        ...
                        {steps.map((step, index) => {
                            ...
                            return (
                                <div key={step.id} className="flex flex-col items-center bg-surface-hover px-2">
                                    <div
                                        className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 transition-colors ${isActive ? 'bg-purple-600 text-white' :
                                                isCompleted ? 'bg-green-500 text-white' : 'bg-border text-ink-tertiary'
                                            }`}
                                    >
                ...
                <div className="flex-1 overflow-y-auto px-8 py-6">
                    ...
                    {currentStep === 4 && (
                        <div>
                            ...
                            <p className="text-ink-secondary mb-6">Choose a winning ad template to base your new ads on</p>
                ...
                {/* Footer Actions */}
                <div className="px-8 py-6 border-t border-border flex items-center justify-between bg-surface-hover">
                    <button
                        onClick={onCancel}
                        className="px-4 py-2 text-ink-secondary hover:text-ink font-medium"
                    >
                        Cancel
                    </button>
                    <div className="flex gap-3">
                        {currentStep > 1 && currentStep !== 4 && (
                            <button
                                onClick={prevStep}
                                className="flex items-center gap-2 px-6 py-3 bg-border text-ink-secondary rounded-lg hover:bg-border font-medium"
                            >
                                <ChevronLeft size={20} />
                                Back
                            </button>
                        ...
                        {currentStep < steps.length && currentStep !== 4 && (
                            <button
                                ...
                                className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium ${canProceed()
                                        ...
                                        : 'bg-border text-ink-tertiary cursor-not-allowed'
                                    }`}
                            >
                                Next
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {brands.map(brand => (
                    ...
                    >
                        ...
                        {brand.voice && (
                            <div className="text-sm text-ink-secondary bg-surface-hover p-2 rounded">
            ...
            <div className="max-w-md mx-auto">
                <div className="flex items-center gap-4 mb-6">
                    <input
                        ...
                        className="flex-1 h-2 bg-border rounded-lg appearance-none cursor-pointer accent-purple-600"
                    />
...
function CampaignDetailsStep({ details, onChange }) {
    return (
        <div>
            ...
            <p className="text-ink-secondary mb-6">Provide details to customize your ad copy</p>
