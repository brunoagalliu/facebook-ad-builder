    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            ...
            <div className="bg-surface rounded-lg shadow-sm border border-border p-6 mb-6">
                ...
                {blacklist.length === 0 ? (
                    <p className="text-ink-tertiary text-center py-8">No blacklisted pages</p>
                ) : (
                    <div className="space-y-2">
                        {blacklist.map((item) => (
                            <div key={item.id} className="flex justify-between items-center p-3 bg-surface-hover rounded border border-border">
                                <div>
                                    <p className="font-medium">{item.page_name}</p>
                                    {item.reason && <p className="text-sm text-ink-secondary">{item.reason}</p>}
                                </div>
                                <button
            ...
            <div className="bg-surface rounded-lg shadow-sm border border-border p-6">
                ...
                {keywordBlacklist.length === 0 ? (
                    <p className="text-ink-tertiary text-center py-8">No blacklisted keywords</p>
                ) : (
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-surface rounded-lg p-6 max-w-md w-full mx-4">
                        ...
                        <input
                            ...
                            className="w-full p-3 border border-border rounded-lg focus:ring-2 focus:ring-red-500 outline-none mb-4"
                            autoFocus
                        />
